import type { ImportDiagnostic, ProjectDocument, ProjectFileMetadata, ProjectSavePlan } from '@genoffice/project-contracts'
...
export interface ProjectFileAdapter {
  ...
  import(input: Uint8Array, metadata?: ProjectFileMetadata): { document: ProjectDocument; diagnostics: ImportDiagnostic[] }
