    ...
    () => [
      {
        key: 'word',
        title: 'Word',
        description: 'Create and edit rich documents in the browser.',
        route: '/office/word',
      },
      {
        key: 'excel',
        title: 'Excel',
        description: 'Create and edit spreadsheets in the browser.',
        route: '/office/excel',
      },
    ],
    [],
    ...
    <section style={{ maxWidth: 1180, margin: '0 auto', padding: 32 }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ margin: 0, opacity: 0.72, maxWidth: 720, lineHeight: 1.6 }}>
          Browser-first Word and Excel workspaces built on the same product surface as the desktop
          editors.
        </p>
      </div>
      <div
        ...
        {cards.map((card) => (
          <button
            ...
            style={{
              ...
              background: '#fff',
              cursor: 'pointer',
              boxShadow: '0 8px 24px rgba(20,30,50,.06)',
            }}
          >
