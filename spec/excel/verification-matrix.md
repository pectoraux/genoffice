...
- DEPLOYED: NOT YET — production E2E against genoffice.vercel.app must run after merge with the deployed SHA exactly matching merged main (the architect owns the merge + VERIFIED transitions).
