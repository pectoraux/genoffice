...
- DEPLOYED: NOT YET — awaiting PR → CI web gate → ARCHITECT_REVIEW → merge; production E2E against genoffice.vercel.app runs after merge (the architect owns the merge + VERIFIED transitions).
